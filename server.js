...
setInterval(() => {
  http.get(`http://damerystem412.glitch.me/`); ///تعديل مهم حط بدل 333م البروجكت
}, 280000);
...
const admin = "=";
var owner = "729800829044785263"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  console.log(`----------------`);
  console.log(`VineWood`);
  console.log(`----------------`);
  console.log(
    `ON ${client.guilds.size} Servers '     Script By : VineWood  `
  );
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("اسم السيرفر"); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفر
